...
public class ShipTest
{
	...
	{
		Battleship ship = new Battleship(new Board(10), 1, 1, ShipVector.Right);
	...
	{
		Cruiser ship = new Cruiser(new Board(10), 1, 1, ShipVector.Right);
	...
	{
		Destroyer ship = new Destroyer(new Board(10), 1, 1, ShipVector.Right);
	...
	{
		Submarine ship = new Submarine(new Board(10), 1, 1, ShipVector.Right);
	...
	{
		Mine ship = new Mine(new Board(10), 1, 1, ShipVector.Right);
	...
	{
		Minesweeper ship = new Minesweeper(new Board(10), 1, 1, ShipVector.Right);
